...
print(fit_model1, pars=c("mu","beta0","sigma"),include=T)
...
print(fit_model2, pars=c("mu","beta0","beta1","sigma"),include=T)
```
##Model 3
```{r, cache = TRUE}
...
print(fit_model3, pars=c("mu","beta0","beta1","beta2","sigma"),include=T)
